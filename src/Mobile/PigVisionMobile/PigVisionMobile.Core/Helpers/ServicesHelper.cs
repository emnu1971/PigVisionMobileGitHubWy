using PigVisionMobile.Core.Models.Basket;
using PigVisionMobile.Core.Models.Catalog;
using PigVisionMobile.Core.Models.Marketing;
...
namespace PigVisionMobile.Core.Helpers
{
