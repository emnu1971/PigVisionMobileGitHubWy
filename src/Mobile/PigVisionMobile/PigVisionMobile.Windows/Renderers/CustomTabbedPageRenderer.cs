using PigVisionMobile.Core.Controls;
using PigVisionMobile.Windows.Controls;
using PigVisionMobile.Windows.Extensions;
using PigVisionMobile.Windows.Helpers;
using PigVisionMobile.Windows.Renderers;
...
namespace PigVisionMobile.Windows.Renderers
{
    [Preserve]
